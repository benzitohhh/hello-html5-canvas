...
function draw() {
  ...
  ctx.globalCompositeOperation = 'destination-over'; // hmmmm why not just render the sun first???
  ...
  // Moon
  ctx.save();
  ctx.rotate( ((2*Math.PI)/6)*time.getSeconds() + ((2*Math.PI)/6000)*time.getMilliseconds() ); // rev-time 6s
